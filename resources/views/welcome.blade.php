            ...
            <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true ">
                <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                    <router-link to="/home" class="sidebar-brand d-flex align-items-center justify-content-center">
                        ...
                        <div class="sidebar-brand-text mx-3">MH Enterprize</div>
                    </router-link>
                    ...
                    <li class="nav-item bg-info">
                        <router-link to="/pos" class="nav-link" href="index.html">
                            <i class="fas fa-fw fa-tachometer-alt"></i>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <footer class="sticky-footer bg-white">
                    ...
                    <div class="copyright text-center my-auto">
                        ...
                        <b><a href="https://github.com/maruf-229" target="_blank">Maruf Hossain</a></b>
                        </span>
                    </div>
                    </div>
                </footer>
