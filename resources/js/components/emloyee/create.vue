                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="user" @submit.prevent="employeeInsert" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Enter Employee Full Address" v-model="form.address">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Enter Employee NID No." v-model="form.nid">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Enter Employee Contact Number" v-model="form.phone">
